...
- **Test automation**: E2E automation with Playwright, following the Page Object Model
- **API testing**: validating REST endpoints and request/response behavior with Postman
- **Database validation**: SQL queries to verify backend data integrity
